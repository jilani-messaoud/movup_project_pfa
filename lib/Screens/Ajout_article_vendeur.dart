...
class _ajout_article_vendeurstate extends State<ajout_article_vendeur>{
  ...
  TextEditingController _nom = TextEditingController();
   String? filename;
   String? image_url;
  final categories =['informatique','electromenage','nourriture','decoration'];
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                reusableTextField("reference", Icons.format_color_text, false,
                    _ref),
                const SizedBox(
                  height: 20,
                ),
                reusableTextField("nom", Icons.format_color_text, false,
                    _nom),
                const SizedBox(
                  height: 20,
                ),
                ...
                reusableTextField("quantite", Icons.format_color_text, false,
                    _qte),
                const SizedBox(
                  height: 20,
                ),
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                      ...
                      if(result==null){
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("aucune fichier selectionnee"),
                        ),
                        );
                        return null;
                      }
                      ...
                      storage.uploadFile(path, filename!).then((value) => ScaffoldMessenger.of(context).showSnackBar( SnackBar(content: Text("done"))));
                ...
                DropdownButton<String>(
                  ...
                  onChanged: (categories_val)=>setState(() =>this.categories_val=categories_val
                  ),
                ),
  ...
  DropdownMenuItem<String> buildmenucategories(String categories)=> DropdownMenuItem(
    value: categories,
    child: Text(
      categories,
